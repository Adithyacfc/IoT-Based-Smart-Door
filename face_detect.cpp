...
int main(int argc, const char *argv[]) {
    ...
    if (argc != 3) {
        cout << "usage: " << argv[0] << "/usr/share/opencv/haarcascades/haarcascade_frontalface_alt.xml 0" << endl;
        cout << "\t /usr/share/opencv/haarcascades/haarcascade_frontalface_alt.xml -- Path to the Haar Cascade for face detection." << endl;
    ...
    for(;;) {
      	...
      	// delete the following line , if resizing doesn't work
      	resize(original, original, Size(640,360), 0, 0, INTER_CUBIC);
			...
			for(int i = 0; i < faces.size(); i++) {
					...
					/*		cmd1<<"curl --data \"tag=flag&value=1&submit=Store \\a \\value\" http://vadistinydb.appspot.com/storeavalue &";
							...
							cmd1<<"curl --data \"tag=flag&value=1&submit=Store \\a \\value\" http://testfileup-1219.appspot.com/storeavalue &";
							string cmds1 = cmd1.str();	
							system(cmds1.c_str());
							system("php sms.php"); 
							...
							stringstream  ssfn;
							ssfn<<"/home/pi/smart_door/bck/"<<1900+ltm->tm_year<<"_"<<1+ltm->tm_mon<<"_"<<ltm->tm_mday<<"_"<<ltm->tm_hour<<"_"<<1+ltm->tm_min<<"_"<<ltm->tm_sec<<"_"<< ".png";
							filename = ssfn.str();
					...
					/*		cmd2<<"curl -F \"fileToUpload=@"<<ssfn.str()<<"\" http://vadiedu.com/viewimg/upload.php&";
		                	...
		                	cmd2<<"curl -F \"fileToUpload=@"<<ssfn.str()<<"\"  http://104.155.224.186/smartdoor/upload_new.php &";
							string cmds2 = cmd2.str();	
							cout<<cmds2.c_str();
							system(cmds2.c_str()); 
						...
						cmd3<<"curl --data \"message=Visit http://104.155.224.186/smartdoor/uploads/latest.png to view the latest snapshot!! Also open your APP\" http://104.155.224.186/smartdoor/contact_me.php &";
							string cmds3 = cmd3.str();	
							cout<<cmds3.c_str();
							system(cmds3.c_str()); 
							first=0;
